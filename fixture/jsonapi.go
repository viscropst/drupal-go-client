...
func SimpleManyPayload() *jsonapi.ManyPayload {
	fixture := []byte(`
{
  "links": {
    "self": "http://example.com/articles",
  ...
  "included": [{
	...
	res := new(jsonapi.ManyPayload)
	json.Unmarshal(fixture, res)
	return res
}

func SimpleOnePayload() *jsonapi.OnePayload {
	fixture := []byte(`
{
  "links": {
    "self": "http://example.com/articles",
